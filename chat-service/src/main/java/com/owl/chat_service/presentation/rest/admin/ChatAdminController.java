...
public class ChatAdminController {
    ...
    public ChatAdminController(GetChatAdminServices getChatAdminServices,
    ...
    public ResponseEntity<?> getChats(
        ...
        try {
            return ResponseEntity.ok().body(getChatAdminServices.getChats(keywords, page, size, ascSort, status, type,
                    initiatorId, createdDateStart, createdDateEnd));
        } catch (Exception e) {
    ...
    @Operation(security = @SecurityRequirement(name = "bearerAuth"))
    public ResponseEntity<String> patchChatAvatar(@PathVariable String chatId,
